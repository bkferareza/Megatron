var app = angular.module('EMSApp', ['ngRoute', 'ngResource', 'usersModule', 'dashboardModule',
    'templateModule', 'datapointModule', 'auditTrailModule', 'discussionsModule', 'ngAnimate', 'ui.bootstrap', 'timer', 'angular.filter'])
    .value("toastr", toastr);
...
app.service("Permissions", ['$http', '$q', function ($http, $q) {
    ...
    function getPermissions() {
        ...
        $http({ method: 'GET', url: '/UserManagement/get-permissions' })
            .success(function (data, status, header, config) {
                deferred.resolve(data);
            })
            .error(function (data, status, headers, config) {
