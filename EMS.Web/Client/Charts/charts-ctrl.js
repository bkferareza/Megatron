app.controller('ChartController', function ($scope, toastr, datapointsFactory, CurrentUser, chartFactory, GeneralConfiguration, Permissions) {
						       ...
						       if (chart.QueryMode == 2)
						       {
						           chartFactory.getGroupDatapoints(chart.ID)
						               .then(function (result) {
								           ...
								           chart.Datapoints, "chartdiv", true, $scope.$GeneralConfiguration.generalConfiguration().StartOfWeek);
						                   $scope.loading = false;
