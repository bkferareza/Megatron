    ...
    $scope.aggregateOptions2 = [{ "Name": "Average", "value": 1 },
        ...
        $scope.$watch('chart.Month', function (value) {
            ...
            if (value != undefined) {
                ...
                if ($scope.chart != undefined) {
                    ...
                    $scope.chart.Month = newDate.getMonth() + 1;
        ...
        $scope.modifyChart = function(chart)
        {
            ...
            if (chart.RangeValue != undefined) {
                ...
                $scope.chart.Month = date.getMonth() + 1;
                $scope.chart.Day = date.getDate();
                $scope.chart.Hours = date.getHours();
                $scope.chart.Minutes = date.getMinutes();
            }
        ...
        $scope.viewChartWindow = function (displayChart) {
            ...
            templatesFactory.getLogs(displayChart.ID)
                .then(function (result) {
                    ...
                    drawChart(displayChart.ChartType, displayChart.Interval, $scope.chartData, $scope.chartDataColumn, $scope.selected, "chartdiv")
